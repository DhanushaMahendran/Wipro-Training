...
public class Annotations {
	...
	public void beforeSuite() {
		System.out.println("Start of the student");
	}
	@BeforeTest
	...
	public void beforeMethod() {
		System.out.println("Navigate to orangeHRM login page");
		driver.get("https://opensource-demo.orangehrmlive.com/");
	}
	@Test(priority=1)
	...
	public void LoginTest() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@name='/username']"))).sendKeys("Admin");
